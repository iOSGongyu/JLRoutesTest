...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        NSString *urlStr = [NSString stringWithFormat:@"JLRoutesTest2017://MouduleA/ModuleANativePageViewController/setParameter/%@",jsonStr];
        urlStr = [urlStr stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
        viewUrl = [NSURL URLWithString:urlStr];
        
    } else if (indexPath.row == 1) {
        viewUrl = [NSURL URLWithString:@"JLRoutesTest2017://MouduleA/ModuleARNPageViewController/setParameter/666"];
        
    } else if (indexPath.row == 2) {
        viewUrl = [NSURL URLWithString:@"JLRoutesTest2017://MouduleA/ModuleAH5PageViewController/setParameter/666"];
